...
namespace Systeme.Jeu
{
    ...
    public class Grille
    {
        ...
        private readonly Para para; // ← stocker para

        public Grille(int lignes, int colonnes, Para para) // ← para en paramètre
        {
            this.para = para;
            Lignes = lignes;
            Colonnes = colonnes;
            ...
            for (int y = 0; y < lignes; y++)
                for (int x = 0; x < colonnes; x++)
                    Cellules.Add(new Cellule
                    {
                        ...
                        Y = y,
                        Etat = 0,
                        Couleur1 = para.Couleur1,
                        Couleur2 = para.Couleur2
                    });
        }
        ...
        public Grille Clone()
        {
            var g = new Grille(Lignes, Colonnes, para); // ← para passé au clone
